...
const chooseTargetWithValue = (freeAgentsOrUnspawned: 'unspawned' | Unit[], team: Team, state: GameMessage): [Position, number] | null => {
...
export { chooseTarget,chooseTargetWithValue }